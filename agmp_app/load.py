...
def populate_drug():
    df = pd.read_csv("/Users/perceval/que/dummy_data/drug.csv")
    #print(df)
...
def populate_genes():
    df = pd.read_csv("/Users/perceval/que/dummy_data/pharmacogenes.csv")
...
def populate_study():
    df = pd.read_csv("/Users/perceval/que/dummy_data/study.csv")
    for index, row in df.iterrows():
...
def populate_snp():
    df = pd.read_csv("/Users/perceval/que/dummy_data/snp.csv")
    for index, row in df.iterrows():

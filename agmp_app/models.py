...
# #Gene ids
# def increment_genee_id():
#     last_genee_id = Geneagmp.objects.all().order_by('id').last()
#     if not last_genee_id:
#         return 'GENE001'
#     genee_id = last_genee_id.genee_id
#     width = 3
#     genee_id_int = int(genee_id.split('GENE')[-1])
#     new_genee_id_int = genee_id_int + 1
#     formatted = (width - len(str(new_genee_id_int))) * \
#         "0" + str(new_genee_id_int)
#     new_genee_id = 'DRUG' + str(formatted)
#     return new_genee_id
...
class Geneagmp(models.Model):
    ...
    uniprot_ac= models.CharField(max_length=50, null=True, blank=True)
      # will be autogenerated on save
    # genee_id = models.CharField(
    #     max_length=255, default=increment_genee_id, null=True, blank=True)
    class Meta:
